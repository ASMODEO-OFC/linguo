	  ...
	  case 'marcar':
		...
		client.sendMessage(from, foto, MessageType.image, {quoted: mek, caption: `Su porcentaje de gay es: ${pcptgay}`})
          ...
          case 'fiel':
                ...
                client.sendMessage(from, foto, MessageType.image, {quoted: mek, caption: `Su porcentaje de puta es: ${pcptfiel}`})
                break
          case 'cogible':
                if (!isGroup) return reply(mess.only.group)
                if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return
                ...
                client.sendMessage(from, foto, MessageType.image, {quoted: mek, caption: `Su porcentaje de puta es: ${pcptcog}`})
                break
          case 'puta':
                if (!isGroup) return reply(mess.only.group)
                if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return
